object FRMERPExportacaoCBLCompras: TFRMERPExportacaoCBLCompras
  Left = 56
  Top = 114
  Width = 944
  Height = 591
  Caption = 'Exporta'#231#227'o de Compras CBL:'
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object AdvPanel4: TAdvPanel
      ...
      object CbMovimentosIntDatas: TAdvOfficeRadioGroup
        Left = 8
        Top = 46
        Width = 377
        Height = 52
        ...
        Items.Strings = (
            ...
            'Incluir Documentos registados no periodo, com data doc. anterior' +
            '.'
          
            'Excluir Documentos registados no periodo, com data doc. anterior' +
            '.')
        Ellipsis = False
      end
      object GbIDInternosStocks: TAdvGroupBox
        Left = 392
        Top = 40
        Width = 281
        Height = 58
        Caption = 'Exportar apenas ID_Internos:'
        TabOrder = 2
    ...
    object Grelha: TAdvStringGrid
      ...
      FloatFormat = '%.4f'
      GridImages = dmSBRecursos.SBImagensPopup16x16
    ...
    object PanelTotCmp: TAdvPanel
      ...
      object lbTotaldocAnt: TLabel
        Left = 329
        Top = 16
        Width = 100
        Height = 13
        Caption = 'Total Doc.Dt.Anterior'
        Transparent = True
        Visible = False
      end
      object StTotalDocmp: TStaticText
        Left = 275
        Top = 14
        Width = 46
        Height = 20
      ...
      object stTotalDoCCmpAnt: TStaticText
        Left = 435
        Top = 13
        Width = 46
        Height = 20
