...
uses IERPOglobais, SBBEAplicacao;
{$R *.dfm}

Procedure TFRMIERPAcerca.CarregaImagemFundo;
Var
...
End;
procedure TFRMIERPAcerca.FormShow(Sender: TObject);
begin
 Aberto := True;
  self.Height := 200;
...
procedure TFRMIERPAcerca.AdvGlowButton1Click(Sender: TObject);
begin
  if Aberto Then
    self.Height := 254
  Else
...
procedure TFRMIERPAcerca.AdvGlowButton3Click(Sender: TObject);
begin
  self.close;
end;

procedure TFRMIERPAcerca.FormClose(Sender: TObject;
